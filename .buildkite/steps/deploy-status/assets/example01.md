...
<p class="h2 pb1">🐥 Buildkite Deployment Status Demo</p>
...
<p class="h6 my0 regular italic"><a href="$BUILDKITE_BUILD_URL#$BUILDKITE_JOB_ID">View the $BUILDKITE_LABEL job and logs in real time.</a></p>
<p class="h6 my0 regular italic">Click here to view the $BUILDKITE_LABEL job and logs in real time.This annotation was generated by the <a href="$BUILDKITE_BUILD_URL#$BUILDKITE_JOB_ID">$BUILDKITE_LABEL</a> job. This is <a href="artifact://assets/example01.md">the artifact</a> that was used.</p>
